...
def optimizer():
    ...
    def compute(x): 
        ...
        iter_dir = f'1_16_2026/PurcellOptimization3/iteration_{iter_num:03d}'
        taper = u.tapering(382, x[0], 5)    
        _,__,___, result = u.defectandmirrors(width = 500, length = 337, xlength = 218, ylengths = taper, mirrorlength = 382, excitation= mp.Ez, nummirrors= 16,
        ...
        with open(os.path.join(iter_dir,"optimization.txt"), "w") as f:
                ...
                f.write(f"  Number of defect holes: {5}\n")
                f.write("="*30 + "\n")
